...
def edit():
    ...
    records = c.fetchall()  # fetchone(),fetchmany(50)also exists
    ...
    f_name_editor_label = Label(editor, text="First_name")
    f_name_editor_label.grid(row=0, column=0, pady=(10, 0))
    l_name_editor_label = Label(editor, text="Last_name")
...
submit_btn = Button(root, text="Add record to databases", command=submit)
submit_btn.grid(row=6, column=0, columnspan=2, padx=10, pady=10, ipadx=100)
#add query button
q_btn = Button(root, text="Show Record", command=query)
